...
namespace FormationMonCtrl
{
    #region [Class CtrlFormationBoxHPC]
    /////////////////////////////////////////////////////////////////////
    //	Class:  CtrlFormationBoxHPC
    //===================================================================
    public partial class CtrlFormationBoxHPC : UserControl
    {
        #region [Variable]
        ...
        //	Constructor
        //===================================================================
        public CtrlFormationBoxHPC()
        {
            // InitializeComponent
            InitializeComponent();

            m_boBoxObject = new CBoxObject[5];
        ...
        public static readonly RoutedEvent BoxClickedEvent = EventManager.RegisterRoutedEvent("BoxClicked", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(CtrlFormationBoxHPC));
		...
		protected void HPCBox_MouseClick(object sender, System.Windows.Input.MouseButtonEventArgs e)
		{
   ...
   //         CBoxClickedEventArgs args = new CBoxClickedEventArgs(nBoxNumber);
        ...
        //KJY for Test
        protected void HPCText_MouseClick(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            //string strObjectName = ((Border)sender).Name;
