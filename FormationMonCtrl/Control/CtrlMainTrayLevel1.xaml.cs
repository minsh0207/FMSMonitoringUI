...
namespace FormationMonCtrl
{
    #region [Class CtrlMainTrayLevel1]
    /////////////////////////////////////////////////////////////////////
    //	Class:  CtrlFormationBoxHPC
    //===================================================================
    public partial class CtrlMainTrayLevel1 : UserControl
    {
        #region [Variable]
        ...
        public static readonly RoutedEvent BoxClickedEvent = EventManager.RegisterRoutedEvent("BoxClicked", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(CtrlMainTrayLevel1));
