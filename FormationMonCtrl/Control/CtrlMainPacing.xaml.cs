...
namespace FormationMonCtrl
{
    #region [Class CtrlMainPacking]
    /////////////////////////////////////////////////////////////////////
    //	Class:  CtrlFormationBoxHPC
    //===================================================================
    public partial class CtrlMainPacking : UserControl
    {
        #region [Variable]
        ...
        public static readonly RoutedEvent BoxClickedEvent = EventManager.RegisterRoutedEvent("BoxClicked", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(CtrlMainPacking));
        ...
        //	Set Box
        //===================================================================
        public void setBox(string trayID, string palletID)
        {
            int nIndex = 0;
            m_boBoxObject[nIndex++].m_txtDisplayInfo.Text = trayID;
            m_boBoxObject[nIndex++].m_txtDisplayInfo.Text = palletID;
        }
        #endregion
        #endregion
    }
