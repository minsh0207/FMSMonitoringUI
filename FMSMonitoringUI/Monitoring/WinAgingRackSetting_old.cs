...
{
    public partial class WinAgingRackSetting_old : WinFormRoot
    {
        ...
        public WinAgingRackSetting_old()
        {
            InitializeComponent();
        }

        public WinAgingRackSetting_old(string strAgingType, string strUnitID, string strTrayID, string strStatus = "E")
        {
