...
{
    #region [Class]
    public partial class CtrlComboProcessName : CtrlComboRoot
    {
        ...
        private void CtrlCombo_Load(object sender, EventArgs e)
        {
            ...
            if(TitleText.Length <= 0)
                TitleText = LocalLanguage.GetItemString("DEF_CONTROL_095");
            else
                TitleText = LocalLanguage.GetItemString(TitleText);
        ...
        /// </summary>
        /// <returns></returns>
        public void InitComboBoxList(bool bNull, string strFilter = "", string strOrder = "")
        {
            try
            {
                //Init
                ...
                //Data Set
                cbItems.DataSource = GetListTable(enDBTable.MST_ROUTE_OPER, bNull, strFilter, strOrder);
