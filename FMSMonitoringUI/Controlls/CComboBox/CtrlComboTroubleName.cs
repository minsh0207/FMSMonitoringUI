...
{
    #region [Class]
    public partial class CtrlComboTroubleName : CtrlComboRoot
    {
        ...
        #region [Load]
        private void CtrlComboTroubleName_Load(object sender, EventArgs e)
        {
            m_bLoadFlag = true;

            TitleText = LocalLanguage.GetItemString("DEF_SPREAD_015");
        ...
        public void InitComboBoxList(bool bNull, string strFilter = "")
        {
            try
            {
                ...
                //Data Set
                cbItems.DataSource = GetListTable(enDBTable.MST_TROUBLE, bNull, strFilter);
