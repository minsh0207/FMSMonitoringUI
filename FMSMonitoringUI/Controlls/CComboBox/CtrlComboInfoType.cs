...
{
    #region [Class]
    public partial class CtrlComboInfoType : CtrlComboRoot
    {
        ...
        private void CtrlCombo_Load(object sender, EventArgs e)
        {
            ...
            TitleText = LocalLanguage.GetItemString("DEF_CONTROL_127");
        ...
        private void InitComboBoxList()
        {
            try
            {
                ...
                //Data Set
                cbItems.DataSource = CDataTable.TableCellInfo();
