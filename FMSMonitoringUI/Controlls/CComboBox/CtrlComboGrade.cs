...
{
    #region [Class]
    public partial class CtrlComboGrade : CtrlComboRoot
    {
        ...
        private void CtrlCombo_Load(object sender, EventArgs e)
        {
            ...
            TitleText = LocalLanguage.GetItemString("DEF_SPREAD_044");
        ...
        /// </summary>
        /// <returns></returns>
        public void InitComboBoxList(int nIndex)
        {
            try
            {
                //Init
                ...
                //Data Set
                cbItems.DataSource = CDataTable.TableItemGrade(nIndex);
