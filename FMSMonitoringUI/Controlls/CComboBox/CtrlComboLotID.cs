...
{
    #region [Class]
    public partial class CtrlComboLotID : CtrlComboRoot
    {
        ...
        private void CtrlCombo_Load(object sender, EventArgs e)
        {
            ...
            TitleText = LocalLanguage.GetItemString("DEF_SPREAD_086");
        ...
        public void InitComboBoxList(bool bNull, string strFilter = "")
        {
            try
            {
                ...
                //Data Set
                cbItems.DataSource = GetListTable(enDBTable.LOT_INFO, bNull, strFilter);
        ...
        /// </summary>
        /// <returns></returns>
        public void InitComboBoxListQuery(bool bNull, List<string>  lstVar)
        {
            try
            {
                //Init
                ...
                {
                    //Data Set
                    cbItems.DataSource = GetListTableGroupBy(enDBTable.GROUPBY_LOT, bNull, lstVar);
                }
                else
                {
                    //Data Set
                    cbItems.DataSource = GetListTableGroupBy(enDBTable.HIST_DB_GROUPBY_LOT, bNull, lstVar);
                }
