...
{
    #region [Class]
    public partial class CtrlComboEqpState : CtrlComboRoot
    {
        ...
        private void CtrlCombo_Load(object sender, EventArgs e)
        {
            ...
            TitleText = LocalLanguage.GetItemString("DEF_SPREAD_115");
        ...
        /// </summary>
        /// <returns></returns>
        public void InitComboBoxList(DataTable dt)
        {
            try
            {
                //Init
