...
{
    public partial class CtrlCharger : UserControl
    {
        public CtrlCharger()
        {
            InitializeComponent();
        ...
        #region Properties
        string _reckID = "";
        [DisplayName("Reck ID"), Description("Rack ID"), Category("GroupBox Setting")]
        public string ReckID
        {
            ...
            {
                _reckID = value;
                ractCHG.Text = string.Format($"Rack ID : {_reckID}");
            }
        }
        #endregion
